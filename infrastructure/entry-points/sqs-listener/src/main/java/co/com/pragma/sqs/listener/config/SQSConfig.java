...
public class SQSConfig {
    ...
    @Bean("sqsListenerValidacion")
    public SQSListener sqsListener(@Qualifier("sqsAsyncClientListener") SqsAsyncClient client, SQSProperties properties, Function<Message, Mono<Void>> fn) {
