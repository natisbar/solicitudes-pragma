...
public record PrestamoSolicitudDto(
        ...
        @Pattern(regexp = PATRON_MONTO, message = "El salario base debe ser un valor numerico entre 0 y 15000000")
        String monto,

        @Schema(example = "12")
        @NotBlank(message = "El plazo es obligatorio y no puede estar vacio")
        @Pattern(regexp = PATRON_ENTERO_POSITIVO, message = "El plazo(meses) debe ser mayor a 0")
        String plazo,
        ...
        @Pattern(regexp = PATRON_ENTERO_POSITIVO, message = "El id del tipo de prestamo debe ser mayor a 0")
